...
from django.contrib.auth.decorators import login_required #returns true or false -> gives permission to usage of view actions based off user login activities # decorators : function return other functions
